...
if(function_exists('wpjam_load')){
	wpjam_load('wpjam_debug_loaded', function(){
		if(function_exists('wpjam_register_debug_type')){
...
if(function_exists('wpjam_register_lazyloader')){
	wpjam_register_lazyloader('weixin_account',	[
		'filter'		=> 'weixin_get_account',
		'callback'		=> ['WEIXIN_Extend', 'lazyload_callback'],
		'accepted_args'	=> 2
	]);
} elseif(function_exists('wpjam_lazyloader')){
	wpjam_lazyloader('weixin_account',	[
		'filter'		=> 'weixin_get_account',
		'callback'		=> ['WEIXIN_Extend', 'lazyloader_callback'],
		'accepted_args'	=> 2
	]);
}

if(function_exists('wpjam_register_route')){
