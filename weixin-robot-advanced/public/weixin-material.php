...
class WEIXIN_Material{
	public static function get_type(){
		$type = wpjam_get_current_tab_setting('material_type');
		// 确保返回有效的媒体类型
		return in_array($type, ['image', 'voice', 'video']) ? $type : 'image';
	}
	...
	public static function query_items($limit, $offset){
		...
		$material = weixin()->post('/cgi-bin/material/batchget_material', $args);
...
class WEIXIN_Draft{
	...
	public static function query_items($limit, $offset){
		...
		$response = weixin()->post('/cgi-bin/draft/batchget', $args);
...
class WEIXIN_Publish{
	...
	public static function query_items($limit, $offset){
		...
		$response = weixin()->post('/cgi-bin/freepublish/batchget', $args);
